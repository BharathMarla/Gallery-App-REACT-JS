...
class Gallery extends Component {
  ...
  getFilteredGallery = () => {
    ...
    const filteredGallery = imagesList.filter(
      eachGallery => eachGallery.id === activeTabId,
    )
  ...
  render() {
    const {activeTabId} = this.state
    const filteredGallery = this.getFilteredGallery()
    return (
